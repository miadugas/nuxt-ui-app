    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-6 lg:px-6">
      ...
      <div class="grid gap-8 lg:grid-cols-1">
        ...
        <article v-for="item in items" :key="item._id"
          ...
          <div class="text-center" v-if="showMoreButton">
            <button @click="showMore" class="inline-flex items-center font-medium text-neutral-900  dark:text-neutral-200 hover:text-cyan-500 dark:hover:text-cyan-400 hover:font-bold">
              Read More
